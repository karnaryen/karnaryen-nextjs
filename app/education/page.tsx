...
export default function EducationPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-foreground">{t('coursesTitle')}</h2>
      ...
      <h2 className="mt-16 text-2xl font-semibold text-foreground">{t('mainTitle')}</h2>
      <div className="mt-8 flex flex-col items-center gap-6 rounded-2xl border border-border bg-card p-6 text-center shadow-sm sm:flex-row sm:text-left dark:shadow-lg dark:shadow-black/25">
        <Image
